...
The goal of weighter is to ...

## Installation

You can install the released version of weighter from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("weighter")
```
...
devtools::install_github("mrc-ide/weighter")
```
## Example
